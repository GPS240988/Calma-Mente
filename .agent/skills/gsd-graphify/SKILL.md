---
name: gsd-graphify
description: "Constrói, consulta e inspeciona o gráfico de conhecimento do projeto em .planning/graphs/"
---
...
```
PREFLIGHT=$(node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: $HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs
