---
name: gsd-autonomous
description: "Executa todas as fases restantes de forma autônoma — discute→planeja→executa por fase"
---
...
<process>
Execute the autonomous workflow from @~/.gemini/antigravity/get-shit-done/workflows/autonomous.md end-to-end.
