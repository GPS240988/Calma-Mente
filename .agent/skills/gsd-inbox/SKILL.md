---
name: gsd-inbox
description: "Triagem e revisão de issues e PRs abertos no GitHub em relação aos templates do projeto e diretrizes de contribuição."
---
...
<process>
Execute the inbox workflow from @~/.gemini/antigravity/get-shit-done/workflows/inbox.md end-to-end.
