---
name: gsd-quick
description: "Executa uma tarefa rápida com garantias do GSD (commits atômicos, rastreamento de estado), mas ignora agentes opcionais"
---
...
Execute the quick workflow from @~/.gemini/antigravity/get-shit-done/workflows/quick.md end-to-end.
