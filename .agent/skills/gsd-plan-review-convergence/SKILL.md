...
description: "Loop de convergência de plano entre IAs — replaneja com feedback de revisão até que nenhuma preocupação de nível ALTO permaneça."
---
...
<process>
Execute the plan-review-convergence workflow from @$HOME/.gemini/antigravity/get-shit-done/workflows/plan-review-convergence.md end-to-end.
