...
description: "Inicia um novo ciclo de marco — atualiza o PROJECT.md e encaminha para os requisitos"
---
...
<process>
Execute the new-milestone workflow from @~/.gemini/antigravity/get-shit-done/workflows/new-milestone.md end-to-end.
