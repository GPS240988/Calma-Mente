---
name: gsd-forensics
description: "Investigação pós-morte para fluxos de trabalho GSD com falha — diagnostica o que deu errado."
---
...
<process>
Read and execute the forensics workflow from @~/.gemini/antigravity/get-shit-done/workflows/forensics.md end-to-end.
</process>
