...
description: "Valida recursos construídos através de UAT conversacional"
---
...
<process>
Execute the verify-work workflow from @~/.gemini/antigravity/get-shit-done/workflows/verify-work.md end-to-end.
