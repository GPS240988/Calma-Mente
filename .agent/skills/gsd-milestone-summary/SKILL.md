...
description: "Gera um resumo abrangente do projeto a partir de artefatos de marcos para integração e revisão da equipe"
---
...
<process>
Read and execute the milestone-summary workflow from @~/.gemini/antigravity/get-shit-done/workflows/milestone-summary.md end-to-end.
</process>
