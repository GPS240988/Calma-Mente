---
name: gsd-spike
description: "Explora uma ideia através de exploração experimental, ou propõe o que explorar a seguir (modo fronteira)"
---
...
- If it is `--wrap-up`: strip the flag, execute the spike-wrap-up workflow from @~/.gemini/antigravity/get-shit-done/workflows/spike-wrap-up.md.
- Otherwise: pass all of $ARGUMENTS as the idea to the spike workflow from @~/.gemini/antigravity/get-shit-done/workflows/spike.md end-to-end.
