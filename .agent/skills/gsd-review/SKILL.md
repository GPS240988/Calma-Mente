---
name: gsd-review
description: "Solicita revisão por pares entre IAs de planos de fase a partir de CLIs de IA externas"
---
...
<process>
Execute the review workflow from @~/.gemini/antigravity/get-shit-done/workflows/review.md end-to-end.
</process>
