...
description: "Gera ou atualiza a documentação do projeto verificada em relação à base de código"
---
...
<process>
Execute the docs-update workflow from @~/.gemini/antigravity/get-shit-done/workflows/docs-update.md end-to-end.
