---
name: gsd-manager
description: "Centro de comando interativo para gerenciar múltiplas fases a partir de um único terminal"
---
...
<process>
Execute the manager workflow from @~/.gemini/antigravity/get-shit-done/workflows/manager.md end-to-end.
