...
description: "Revisa arquivos de origem alterados durante uma fase em busca de bugs, problemas de segurança e qualidade de código"
---
...
Execute the code-review workflow from @~/.gemini/antigravity/get-shit-done/workflows/code-review.md end-to-end.
