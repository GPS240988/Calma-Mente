---
name: gsd-fast
description: "Executa uma tarefa trivial de forma direta — sem subagentes, sem sobrecarga de planejamento"
---
...
<process>
Execute the fast workflow from @~/.gemini/antigravity/get-shit-done/workflows/fast.md end-to-end.
</process>
