---
name: gsd-update
description: "Atualiza o GSD para a versão mais recente com exibição do changelog"
---
...
- Otherwise: **Follow the update workflow** from `@~/.gemini/antigravity/get-shit-done/workflows/update.md`.
